...
public class VMachineSample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println();
			System.out.println("This is the information OpenNebula stores for the new VM:");
			...
			rc = vm.shutdown(true);
			System.out.println("\nTrying to cancel the VM " + vm.getId() + " (should fail)...");
			...
			rc = vm.delete();
			System.out.println("\nTrying to finalize (delete) the VM " + vm.getId() + "...");
