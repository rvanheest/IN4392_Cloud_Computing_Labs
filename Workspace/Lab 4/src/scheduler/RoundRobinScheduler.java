...
/**
 * This implementation of {@code Scheduler} assigns each task to a different {@code WorkerHandle}
 * by iterating over {@code workers}. In the case there are more tasks than workers, the iteration
 * of {@code workers} starts all over again.
