...
\textcolor{red}{describe what happens when a worker fails during execution. How is this detected and how is the head node responding to that? Also mention that we assume the head node to not fail.}
