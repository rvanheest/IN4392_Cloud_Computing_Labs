...
\begin{document}
\title{Distributed Mass Image Processing in a Cloud Environment}
...
In this report we will focus on the general idea and the headlines of this project. If you are interested in implementation details, it is available at GitHub\footnote{\url{https://github.com/rvanheest/IN4392_Cloud_Computing_Labs}}.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{SchedulingDelay-W.png}
...
\begin{figure}[h!]
	...
	\caption{Monitored information about the system in the first experiment}
...
\begin{figure}[h!]
	...
	\caption{Overhead time for jobs in the first experiment}
...
\begin{figure}[h!]
	...
	\caption{Monitored information about the system in the second experiment}
...
\begin{figure}[h!]
	...
	\caption{Monitored information about the system in the third experiment}
...
\section{Time sheet}
\label{app:time}
This appendix holds an overview of the number of hours spend on this project, divided in several categories. For a more detailed overview, we refer to our GitHub repository\footnote{\url{https://github.com/rvanheest/IN4392_Cloud_Computing_Labs}}.
